...
@PageTitle("Block")
@Route(value = "block/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Uses(Icon.class)
public class BlockView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "block/%s/edit";
    ...
    @Autowired
    public BlockView(SamplePersonService samplePersonService) {
