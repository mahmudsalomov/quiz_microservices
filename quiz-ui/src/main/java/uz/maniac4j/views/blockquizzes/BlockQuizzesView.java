...
@Route(value = "block-quizzes/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Uses(Icon.class)
public class BlockQuizzesView extends Div implements BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "block-quizzes/%s/edit";
    ...
    @Autowired
    public BlockQuizzesView(SamplePersonService samplePersonService) {
